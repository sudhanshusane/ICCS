...
\hline
\end{tabular}
\caption{In situ encumbrance evaluation and experiment configurations for the SW4 simulation executing on GPUs.}
%Overall, the \textbf{DAV\%} depends on the number of grid points per rank, the number of particles, i.e., the spatial sampling resolution, as well as the \textbf{Sim$_{cycle}$}.}
